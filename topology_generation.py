# Calculate all the possible permutations of a linkage mechanism with one degree
# of freedom from a given kinematic chain composed of N rigid bodies.
